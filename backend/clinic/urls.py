...
urlpatterns = [
    ...
    path("patients/<int:patient_id>/ozempic", views.OzempicDoseListView.as_view()),
    path("patients/<int:patient_id>/ozempic/<int:entry_id>", views.OzempicDoseDetailView.as_view()),
    path("patients/<int:patient_id>/ozempic/corrections", views.OzempicCorrectionLogListView.as_view()),
    path("patients/<int:patient_id>/health-status-notes", views.HealthStatusNoteListView.as_view()),
    path("patients/<int:patient_id>/next-followup-date", views.NextFollowupDateView.as_view()),
