...
urlpatterns = [
    ...
    path("patients/<int:patient_id>/mounjaro/<int:entry_id>", views.MounjaroDoseDetailView.as_view()),
    path("patients/<int:patient_id>/mounjaro/corrections", views.MounjaroCorrectionLogListView.as_view()),
